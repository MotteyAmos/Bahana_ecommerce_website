...
const IMG = (src) => {
  return (
    <img
      src={src}
      alt=""
      className="w-full h-[100%] border-2 hover:scale-110 transitionTheme hover:rotate-[-10deg] hover:z-10 drop-shadow-2xl"
    />
  );
};
  ...
  return (
    <>
      <div className="">
        ...
        >
          <div className="w-full rounded-md border-4 max-sm:h-[12rem] drop-shadow-3xl h-[20rem]  ">
